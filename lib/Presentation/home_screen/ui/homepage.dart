...
import 'package:cleanarchetectureflutterguy/Presentation/spalsh_screen/ui/splash_screen_ui.dart';
          ...
          appBar: AppBar(
            ...
            actions: [
              IconButton(onPressed: () {
                AuthService.clearTokens().then((value) {
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                    builder: (context) => SplashScreenUiWrapper(),));
                },);
